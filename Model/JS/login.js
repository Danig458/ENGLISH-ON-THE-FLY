...
// Configuración de usuarios (simulación, en producción vendría de la base de datos)
    /*const users = {
            'admin': {
                password: 'password',
                role: 'administrador',
                ...
                case 'profesor':
                    content = `
                        ...
                        <div style="margin-top: 20px;">
                            ...
                            <ul style="margin-top: 10px;">
                                <li>12 exámenes por calificar</li>
                                <li>5 tareas pendientes de revisión</li>
                                <li>3 estudiantes necesitan retroalimentación</li>
                            </ul>
                        </div>
                    `;
                    break;
                ...
                case 'estudiante':
                    content = `
                        ...
                        <div style="margin-top: 20px;">
                            ...
                            <ul style="margin-top: 10px;">
                                <li>Examen de Grammar - Viernes 26 de Mayo</li>
                                <li>Tarea de Speaking - Entrega: 28 de Mayo</li>
                                <li>Clase de Conversation - Lunes 29 de Mayo</li>
                            </ul>
                        </div>
                    `;
                    break;
        ...
        if (userId) {
            ...
            // Agregar al arreglo de usuarios y al sistema de autenticación
            allUsers.push(newUser);
            users[newUser.username] = {
                password: userData.password,
                role: userData.rol,
        ...
        // Función para cargar datos del estudiante (placeholder)
        function loadStudentData() {
            // Aquí puedes agregar lógica específica para cargar datos del estudiante
        ...
        document.getElementById('courseForm').addEventListener('submit', function (e) {
            ...
            const descripcion = formData.get('descripcionCurso');

            alert(`Curso "${nombreCurso}" creado con éxito.\nDescripción: ${descripcion}`);
            closeCourseModal();
        });

        function verReportes() {
            alert('Funcionalidad de reportes en construcción...');
        }
        ...
        function showReportSection() {
            ...
            // Muestra la de reportes
            const section = document.getElementById('reportSection');
            section.classList.add('active');

            // Actualiza los valores del reporte
            const total = allUsers.length;
            const profesores = allUsers.filter(u => u.rol === 'profesor').length;
            const estudiantes = allUsers.filter(u => u.rol === 'estudiante').length;

            document.getElementById('totalUsersReport').textContent = total;
            document.getElementById('totalTeachersReport').textContent = profesores;
            document.getElementById('totalStudentsReport').textContent = estudiantes;
        }*/
